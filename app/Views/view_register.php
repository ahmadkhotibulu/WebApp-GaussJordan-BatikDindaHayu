  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      ...
      <form action="" class="mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl">
        ...
        <button type="submit" class="block w-full rounded-lg bg-primary px-5 py-3 text-md font-medium text-white">
          Daftar
        </button>

        <p class="text-center text-sm text-mint-300">
          Sudah memiliki akun!
          <a class="font-extrabold text-primary" href="<?= base_url('login-page'); ?>">Masuk</a>
          di sini.
        </p>
        <?php echo form_close(); ?>
      </form>
