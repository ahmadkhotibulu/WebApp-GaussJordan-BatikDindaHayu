...
<body>
  ...
  <main>
    <article class="mx-auto my-4 bg-body p-4 border-bottom border-success shadow-sm" style="max-width: 55rem;">
      ...
      <h2 class="fs-1 text-success ff-heading">Selamat Datang</h2>
      <p class="fs-6 mb-4">Masukkan data diri anda untuk masuk ke aplikasi.</p>
      <?php
        $session = session();
      ...
      ?>
      <?php echo form_open(base_url('login'), ['class'=>'d-flex flex-column gap-2']);?>
        ...
        <input class="btn btn-success mt-2 px-3 py-2 fs-6 font-weight-bold" type="submit" value="Login">
      <?php echo form_close();?>
      <hr class="border-dark mt-3">
      <p class="mt-3 text-center">Belum memiliki akun? <a class="text-success fw-bold" href="<?= base_url('register-page');?>">Register</a> di sini.</p>
    </article>
  </main>
